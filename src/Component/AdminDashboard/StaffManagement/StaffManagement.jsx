...
const StaffManagement = () => {
  ...
  return (
    <div className="d-flex" style={{ minHeight: '100vh' }}>
      {/* Sidebar */}
      <div className="bg-dark text-white" style={{ width: '250px', position: 'fixed', height: '100%' }}>
        <div className="p-4 border-bottom border-secondary">
          <div className="d-flex align-items-center">
            <div className="bg-warning rounded p-2 me-3 d-flex align-items-center justify-content-center" style={{ width: '40px', height: '40px' }}>
              <span className="text-dark fw-bold">GC</span>
            </div>
            <div>
              <h5 className="mb-0">GameCenter</h5>
        ...
        <Nav className="flex-column p-3">
          ...
          <Nav.Item>
            <Nav.Link active className="bg-warning text-dark rounded d-flex align-items-center">
          ...
          <Container fluid>
            <div>
              ...
              <small className="text-muted">
                Dashboard / <span className="text-dark">Staff Management</span>
              </small>
            </div>
            <div className="d-flex align-items-center">
              <InputGroup className="me-3">
                ...
                <FormControl placeholder="Search staff..." />
              </InputGroup>
              <Button variant="warning" className="text-dark" onClick={() => setShowModal(true)}>
                <Plus className="me-2" />
                Add New Staff
              </Button>
            </div>
