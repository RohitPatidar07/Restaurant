                ...
                <div className="mt-3 text-start">
                  {alert.status === 'OVERDUE' ? (
                    ...
                    <>
                      ...
                      <div className="action-buttons">
                        <button className={`btn btn-sm btn-outline-${alert.color}`}>
                          Notify Customer
                        </button>
                      </div>
                    </>
            ...
            {notifications.reservations.map(reservation => (
              <div key={reservation.id} className={`alert-item alert-${reservation.color}`}>
                ...
                <ul className="alert-details">
                  ...
                  <li className={`fw-bold text-${reservation.color}`}>⏰ {reservation.arrival}</li>
                </ul>

                <div className="mt-3 text-start">
                  <h6 className="small fw-bold">Mark as Arrived</h6>
                  <div className="action-buttons">
                    <button className={`btn btn-sm btn-outline-${reservation.color}`}>
                      Mark as Handled
                    </button>
                  </div>
                </div>
